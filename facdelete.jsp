...
<div class="bd"><div id="page"><div id="main"><div class="content"><h1>Remove Faculty</h1>

<form method=get action="facdelete2.jsp" name=frm onSubmit="return check()">
<br>
<br><br>
<center>
Faculty&nbsp;&nbsp;<input type=textbox name="T1" size=15><br><br>
