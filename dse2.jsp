...
pst=con.prepareStatement("select count(eventid) from event where deptid=? and semester=?");
...
out.print("Total "+count+" events are conducted in "+deptid+" in "+sem+" semester");
}
}
catch(Exception e)
{}                      
