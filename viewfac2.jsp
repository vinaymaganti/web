...
<div class="bd"><div id="page"><div id="main"><div class="content"><h1>Faculty of <%=deptid%></h1><br>
...
//	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","ktc","ktc");
	...
	PreparedStatement pstmt = null;
           pstmt = con.prepareStatement("select * from users where deptid = ? and flag = ?");   
...
PreparedStatement pstmt1 = null;
           pstmt1 = con.prepareStatement("select * from users where deptid = ? and flag=?");   
...
out.print("faculty of "+deptid+" are not registered");
}
...
</div></div><div class="clear" style="height:1000px"></body></html>