...
<div class="bd"><div id="page"><div id="main"><div class="content"><h1>Faculty Password Reset Page</h1>

<br>
<center>
<form method=post action="facreset2.jsp" name="frm" onSubmit="return check()">
<center>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<b>Faculty Id&nbsp;&nbsp;
<input type=textbox name="facid" size=25 maxlength=30><br><br>
