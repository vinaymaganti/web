...
<div class="bd"><div id="page"><div id="main"><div class="content"><h1>Student Password Reset Page</h1>

<br>
<center>
<form method=post action="stureset2.jsp" name="frm" onSubmit="return check()">
<center>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<b>Student Id&nbsp;&nbsp;
<input type=textbox name="stuid" size=25 maxlength=30><br><br>
