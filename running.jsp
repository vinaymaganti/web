...
if(rs.next())
       {%> <center><font color="red" size="6" align="center">Following are Running events that are created by you</font><br><br>
<%
...
while(rs1.next())
    ...
    <font size="4" colour="purple">Eventid:<%=rs1.getString(1)%><br>Semester:<%=rs1.getString(6)%><br>Dept:<%=rs1.getString(4)%><br>
                    <form name="frm" action="disable.jsp">
