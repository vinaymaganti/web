...
<div class="bd"><div id="page"><div id="main"><div class="content"><h1>Change Password</h1>

<form action='fchange2.jsp?userid=<%=userid%>'name=frm onSubmit="return check()" method = post>
