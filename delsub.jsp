...
<div class="bd"><div id="page"><div id="main"><div class="content"><h1>""ADMIN""</h1><center><h2>Delete Subject</h2></center>
<br>
<center>
<table border="0"><form method=post action="delsub2.jsp" name="frm" onSubmit="return check()">
