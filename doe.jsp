...
<div class="bd"><div id="page"><div id="main"><div class="content"><h1>Welcome <%=userid%></h1><center><font color="red" size="5">
 <table border="1"><tr><td>Deptid</td><td>Number of events</td>            <%
try
{
    int count;
...
pst=con.prepareStatement("select deptid from dept");
ResultSet rs=pst.executeQuery();
while(rs.next())
       {
String deptid=rs.getString(1);
PreparedStatement pstmt=null;
pstmt=con.prepareStatement("select count(eventid)from event where deptid=?");
...
count=rs1.getInt(1);
out.print("<tr><td>"+deptid+"</td><td>"+count+"</td></tr>");
}
}
}
catch(Exception e)
