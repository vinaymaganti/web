...
<div class="bd"><div id="page"><div id="main"><div class="content"><h1>""ADMIN""</h1><br><center><h2>View Subject</h2>

<br>
<center><table>
<form method=post action="viewsub2.jsp" name="frm" onSubmit="return check()">
...
<tr><td><br></td></tr>
<br><tr><td><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name=submit type="submit" onclick="return validateR();"></center></td></tr>
</form></table>
