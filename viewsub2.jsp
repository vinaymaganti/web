...
{
	out.print("<tr>");
	out.print("<th colspan=1><font size=5 color=black>Subject Id</th>");
	out.print("<th colspan=1><font size=5 color=black>Subject Name</th>");
	out.print("<th colspan=1><font size=5 color=black>Dept Id</th>");
