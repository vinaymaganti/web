...
if( (selectedCombobox <=0 ) || (selectedCombobox2 <=0))
   {
...
<div class="bd"><div id="page"><div id="main"><div class="content"><h1><b>Faculty Registration</h1>
<table align="center"><form method=post action="facreg2.jsp" name="frm" onSubmit="return check()">

<tr><td><br></td></tr>
<tr><td>Faculty Id</td><td><input type="text" name="facultyid"></td></tr>
<tr><td><br></td></tr>
...
<tr><td><br></td></tr>
<tr><td>Reenter Password</td><td><input type="password" name="cpass" value=""></td></tr>
<tr><td><br></td></tr>
<tr><td><b>Department</td>
