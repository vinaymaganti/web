...
pstmt=con.prepareStatement("select max(eventid) from event where userid=?");
...
out.print("paper Uploaded succesfully<br>");
out.print("Go to home page to start");
}    
%>
