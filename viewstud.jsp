...
<h1>""ADMIN""</h1>
<center><h2>View Students list</h2></center>
<br>
<center>
<form method=post action="viewstud2.jsp" name="frm" onSubmit="return check()">
...
<br><br>
<center><input name=submit type="submit" onclick="return validateR();">
</form>
